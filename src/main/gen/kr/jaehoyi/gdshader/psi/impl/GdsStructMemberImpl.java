...
public class GdsStructMemberImpl extends ASTWrapperPsiElement implements GdsStructMember {

  public GdsStructMemberImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GdsStructMemberNameDecl getStructMemberNameDecl() {
    return findChildByClass(GdsStructMemberNameDecl.class);
  }
