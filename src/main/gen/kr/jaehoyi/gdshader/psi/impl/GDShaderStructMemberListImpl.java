...
public class GDShaderStructMemberListImpl extends ASTWrapperPsiElement implements GDShaderStructMemberList {

  public GDShaderStructMemberListImpl(@NotNull ASTNode node) {
    super(node);
  }
