...
public class GDShaderFunctionNameDeclImpl extends ASTWrapperPsiElement implements GDShaderFunctionNameDecl {

  public GDShaderFunctionNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
