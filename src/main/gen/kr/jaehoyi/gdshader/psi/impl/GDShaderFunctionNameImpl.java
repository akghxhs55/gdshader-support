...
public class GDShaderFunctionNameImpl extends ASTWrapperPsiElement implements GDShaderFunctionName {

  public GDShaderFunctionNameImpl(@NotNull ASTNode node) {
    super(node);
  }
