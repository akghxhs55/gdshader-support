...
public class GdshaderAssignmentOperatorImpl extends ASTWrapperPsiElement implements GdshaderAssignmentOperator {

  public GdshaderAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
