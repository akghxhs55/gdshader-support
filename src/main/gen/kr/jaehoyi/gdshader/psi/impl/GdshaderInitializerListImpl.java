...
public class GdshaderInitializerListImpl extends ASTWrapperPsiElement implements GdshaderInitializerList {

  public GdshaderInitializerListImpl(@NotNull ASTNode node) {
    super(node);
  }
