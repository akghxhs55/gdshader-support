...
public class GdsFunctionCallStatementImpl extends ASTWrapperPsiElement implements GdsFunctionCallStatement {

  public GdsFunctionCallStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public GdsFunctionCall getFunctionCall() {
    return findNotNullChildByClass(GdsFunctionCall.class);
  }
