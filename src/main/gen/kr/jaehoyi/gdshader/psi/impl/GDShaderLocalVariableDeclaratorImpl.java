...
public class GDShaderLocalVariableDeclaratorImpl extends ASTWrapperPsiElement implements GDShaderLocalVariableDeclarator {

  public GDShaderLocalVariableDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }
