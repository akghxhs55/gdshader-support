...
public class GDShaderSwitchStatementImpl extends ASTWrapperPsiElement implements GDShaderSwitchStatement {

  public GDShaderSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
