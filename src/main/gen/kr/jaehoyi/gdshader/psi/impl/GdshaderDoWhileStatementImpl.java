...
public class GdshaderDoWhileStatementImpl extends ASTWrapperPsiElement implements GdshaderDoWhileStatement {

  public GdshaderDoWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
