...
public class GdsConstantDeclaratorImpl extends ASTWrapperPsiElement implements GdsConstantDeclarator {

  public GdsConstantDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }
