...
public class GdsVaryingDeclarationImpl extends ASTWrapperPsiElement implements GdsVaryingDeclaration {

  public GdsVaryingDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GdsInterpolationQualifier getInterpolationQualifier() {
    return findChildByClass(GdsInterpolationQualifier.class);
  }
