...
public class GdsInitializerImpl extends ASTWrapperPsiElement implements GdsInitializer {

  public GdsInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GdsInitializerList getInitializerList() {
    return findChildByClass(GdsInitializerList.class);
  }
