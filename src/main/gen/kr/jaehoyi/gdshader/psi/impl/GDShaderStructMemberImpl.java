...
public class GDShaderStructMemberImpl extends ASTWrapperPsiElement implements GDShaderStructMember {

  public GDShaderStructMemberImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public GDShaderStructMemberName getStructMemberName() {
    return findNotNullChildByClass(GDShaderStructMemberName.class);
  }
