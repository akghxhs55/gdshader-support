...
public class GdsAssignmentOperatorImpl extends ASTWrapperPsiElement implements GdsAssignmentOperator {

  public GdsAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
