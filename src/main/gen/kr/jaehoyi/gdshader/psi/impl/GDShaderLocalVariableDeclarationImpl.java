...
public class GDShaderLocalVariableDeclarationImpl extends ASTWrapperPsiElement implements GDShaderLocalVariableDeclaration {

  public GDShaderLocalVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
