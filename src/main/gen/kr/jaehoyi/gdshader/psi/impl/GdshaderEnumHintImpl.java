...
public class GdshaderEnumHintImpl extends ASTWrapperPsiElement implements GdshaderEnumHint {

  public GdshaderEnumHintImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GdshaderVisitor visitor) {
    visitor.visitEnumHint(this);
  }
