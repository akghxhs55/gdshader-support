...
public class GDShaderExpressionStatementImpl extends ASTWrapperPsiElement implements GDShaderExpressionStatement {

  public GDShaderExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
