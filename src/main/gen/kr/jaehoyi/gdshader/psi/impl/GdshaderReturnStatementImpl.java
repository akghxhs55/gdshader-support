...
public class GdshaderReturnStatementImpl extends ASTWrapperPsiElement implements GdshaderReturnStatement {

  public GdshaderReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
