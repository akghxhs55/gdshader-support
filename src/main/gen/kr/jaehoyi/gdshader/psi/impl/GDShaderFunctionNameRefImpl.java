...
public class GDShaderFunctionNameRefImpl extends ASTWrapperPsiElement implements GDShaderFunctionNameRef {

  public GDShaderFunctionNameRefImpl(@NotNull ASTNode node) {
    super(node);
  }
