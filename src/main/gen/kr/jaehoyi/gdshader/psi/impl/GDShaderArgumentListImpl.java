...
public class GDShaderArgumentListImpl extends ASTWrapperPsiElement implements GDShaderArgumentList {

  public GDShaderArgumentListImpl(@NotNull ASTNode node) {
    super(node);
  }
