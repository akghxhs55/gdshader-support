...
public class GdsIfStatementImpl extends ASTWrapperPsiElement implements GdsIfStatement {

  public GdsIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GdsElseClause getElseClause() {
    return findChildByClass(GdsElseClause.class);
  }
