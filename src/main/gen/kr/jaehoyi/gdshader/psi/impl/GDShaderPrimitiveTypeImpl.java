...
public class GDShaderPrimitiveTypeImpl extends ASTWrapperPsiElement implements GDShaderPrimitiveType {

  public GDShaderPrimitiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
