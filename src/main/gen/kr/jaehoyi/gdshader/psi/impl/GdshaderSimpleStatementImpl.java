...
public class GdshaderSimpleStatementImpl extends ASTWrapperPsiElement implements GdshaderSimpleStatement {

  public GdshaderSimpleStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
