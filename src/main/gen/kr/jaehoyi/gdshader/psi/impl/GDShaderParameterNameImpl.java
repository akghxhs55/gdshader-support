...
public class GDShaderParameterNameImpl extends ASTWrapperPsiElement implements GDShaderParameterName {

  public GDShaderParameterNameImpl(@NotNull ASTNode node) {
    super(node);
  }
