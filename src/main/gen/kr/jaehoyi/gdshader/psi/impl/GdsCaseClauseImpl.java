...
public class GdsCaseClauseImpl extends ASTWrapperPsiElement implements GdsCaseClause {

  public GdsCaseClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GdsCaseBody getCaseBody() {
    return findNotNullChildByClass(GdsCaseBody.class);
  }
