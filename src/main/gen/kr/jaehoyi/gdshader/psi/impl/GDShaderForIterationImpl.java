...
public class GDShaderForIterationImpl extends ASTWrapperPsiElement implements GDShaderForIteration {

  public GDShaderForIterationImpl(@NotNull ASTNode node) {
    super(node);
  }
