...
public class GdshaderConditionalExprImpl extends ASTWrapperPsiElement implements GdshaderConditionalExpr {

  public GdshaderConditionalExprImpl(@NotNull ASTNode node) {
    super(node);
  }
