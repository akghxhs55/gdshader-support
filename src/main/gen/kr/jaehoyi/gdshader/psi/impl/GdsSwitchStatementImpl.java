...
public class GdsSwitchStatementImpl extends ASTWrapperPsiElement implements GdsSwitchStatement {

  public GdsSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GdsSwitchBlock getSwitchBlock() {
    return findChildByClass(GdsSwitchBlock.class);
  }
