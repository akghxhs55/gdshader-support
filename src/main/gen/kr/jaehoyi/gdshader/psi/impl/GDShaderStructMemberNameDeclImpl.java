...
public class GDShaderStructMemberNameDeclImpl extends ASTWrapperPsiElement implements GDShaderStructMemberNameDecl {

  public GDShaderStructMemberNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
