...
object Builtins {
    ...
    // Functions
    val FUNCTIONS: Map<Pair<ShaderType, FunctionContext>, List<FunctionSpec>> by lazy {
        mapOf(
    ...
    // Variables
    val VARIABLES: Map<Pair<ShaderType, FunctionContext>, List<VariableSpec>> by lazy {
        mapOf(
            ShaderType.SPATIAL to FunctionContext.COMMON to globalVariables +
                listOf(
                    ParameterSpec(
                        name = "OUTPUT_IS_SRGB",
                        type = BOOL,
            ...
            ShaderType.SPATIAL to FunctionContext.FRAGMENT to
                listOf(
                    ParameterSpec(
                        name = "VIEWPORT_SIZE",
                        type = VEC2,
            ...
            ShaderType.SPATIAL to FunctionContext.LIGHT to
                listOf(
                    ParameterSpec(
                        name = "VIEWPORT_SIZE",
                        type = VEC2,
            ...
            ShaderType.CANVAS_ITEM to FunctionContext.VERTEX to
                listOf(
                    ParameterSpec(
                        name = "MODEL_MATRIX",
                        type = MAT4,
            ...
            ShaderType.CANVAS_ITEM to FunctionContext.FRAGMENT to
                listOf(
                    ParameterSpec(
                        name = "FRAGCOORD",
                        type = VEC4,
            ...
            ShaderType.CANVAS_ITEM to FunctionContext.LIGHT to
                listOf(
                    ParameterSpec(
                        name = "FRAGCOORD",
                        type = VEC4,
            ...
            ShaderType.PARTICLES to FunctionContext.START to particlesStartAndProcessVariables +
                listOf(
                    ParameterSpec(
            ...
            ShaderType.PARTICLES to FunctionContext.PROCESS to particlesStartAndProcessVariables +
                listOf(
                    ParameterSpec(
                        name = "RESTART",
                        type = BOOL,
            ...
            ShaderType.SKY to FunctionContext.COMMON to globalVariables +
                listOf(
                    ParameterSpec(
                        name = "POSITION",
                        type = VEC3,
            ...
            ShaderType.SKY to FunctionContext.SKY to
                listOf(
                    ParameterSpec(
                        name = "EYEDIR",
                        type = VEC3,
            ...
            ShaderType.FOG to FunctionContext.FOG to
                listOf(
                    ParameterSpec(
                        name = "WORLD_POSITION",
                        type = VEC3,
    ...
    val PROCESSING_FUNCTIONS: EnumMap<ShaderType, List<FunctionContext>> =
        EnumMap(
            mapOf(
                ShaderType.SPATIAL to
                    listOf(
                        FunctionContext.VERTEX,
                        FunctionContext.FRAGMENT,
                        FunctionContext.LIGHT,
                    ),
                ShaderType.CANVAS_ITEM to
                    listOf(
                        FunctionContext.VERTEX,
                        FunctionContext.FRAGMENT,
                        FunctionContext.LIGHT,
                    ),
                ShaderType.PARTICLES to
                    listOf(
                ...
                description =
                    functionDoc(
                        ...
                        params =
                            mapOf(
                                "x" to
                                    "The value to separate.<br>:param out i: A variable that receives the integer part of <code>x</code>.",
                                "i" to "",
                            ),
    ...
    private val fragmentShaderOnlyFunctions =
        listOf(
            FunctionSpec(
                ...
                description =
                    functionDoc(
                        ...
                        params =
                            mapOf(
                                "p" to
                                    "The expression of which to take the partial derivative.<br><br><b>note:</b> It is assumed that the expression <code>p</code> is continuous and therefore expressions evaluated via non-uniform control flow may be undefined.",
                            ),
    ...
    private val particlesStartAndProcessVariables =
        listOf(
            ParameterSpec(
                name = "LIFETIME",
                type = FLOAT,
    ...
    private fun functionDoc(
        ...
        if (params.isNotEmpty()) {
            ...
            params.forEach { (name, desc) ->
                sb.append(
                    "<tr><td valign='top' style='white-space:nowrap'><code>$name</code>&nbsp;&nbsp;</td><td valign='top'>$desc</td></tr>",
                )
            }
            sb.append("</table>")
        }
