...
object GdsHintDocumentation {
    val HINT_DOCS: Map<IElementType, String> =
        mapOf(
            ...
            GdsTypes.HINT_ROUGHNESS_NORMAL_TEXTURE to
                "Used for roughness limiter on import (attempts reducing specular aliasing). <code>_normal</code> is a normal map that guides the roughness limiter, with roughness increasing in areas that have high-frequency detail.",
            GdsTypes.HINT_ROUGHNESS_R to
                "Used for roughness limiter on import (attempts reducing specular aliasing). <code>_normal</code> is a normal map that guides the roughness limiter, with roughness increasing in areas that have high-frequency detail.",
            GdsTypes.HINT_ROUGHNESS_G to
                "Used for roughness limiter on import (attempts reducing specular aliasing). <code>_normal</code> is a normal map that guides the roughness limiter, with roughness increasing in areas that have high-frequency detail.",
            GdsTypes.HINT_ROUGHNESS_B to
                "Used for roughness limiter on import (attempts reducing specular aliasing). <code>_normal</code> is a normal map that guides the roughness limiter, with roughness increasing in areas that have high-frequency detail.",
            GdsTypes.HINT_ROUGHNESS_A to
                "Used for roughness limiter on import (attempts reducing specular aliasing). <code>_normal</code> is a normal map that guides the roughness limiter, with roughness increasing in areas that have high-frequency detail.",
            GdsTypes.HINT_ROUGHNESS_GRAY to
                "Used for roughness limiter on import (attempts reducing specular aliasing). <code>_normal</code> is a normal map that guides the roughness limiter, with roughness increasing in areas that have high-frequency detail.",
