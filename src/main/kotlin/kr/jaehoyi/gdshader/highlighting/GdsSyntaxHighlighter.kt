...
class GdsSyntaxHighlighter : SyntaxHighlighterBase() {
    companion object {
        ...
        val BLOCK_COMMENT =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_BLOCK_COMMENT",
                DefaultLanguageHighlighterColors.BLOCK_COMMENT,
            )
        val LINE_COMMENT =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_LINE_COMMENT",
        ...
        val LOCAL_VARIABLE =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_LOCAL_VARIABLE",
                DefaultLanguageHighlighterColors.LOCAL_VARIABLE,
            )
        val UNIFORM_VARIABLE =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_GLOBAL_VARIABLE",
                DefaultLanguageHighlighterColors.GLOBAL_VARIABLE,
            )
        val VARYING_VARIABLE =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_VARYING_VARIABLE",
                DefaultLanguageHighlighterColors.GLOBAL_VARIABLE,
            )
        val STRUCT_MEMBER =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_STRUCT_MEMBER",
                DefaultLanguageHighlighterColors.INSTANCE_FIELD,
            )
        val BUILTIN_CONSTANT =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_BUILTIN_CONSTANT",
                DefaultLanguageHighlighterColors.CONSTANT,
            )
        val BUILTIN_VARIABLE =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_BUILTIN_VARIABLE",
                DefaultLanguageHighlighterColors.GLOBAL_VARIABLE,
            )
        val FUNCTION =
            TextAttributesKey.createTextAttributesKey(
        ...
        val PREPROCESSOR =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_PREPROCESSOR",
                DefaultLanguageHighlighterColors.METADATA,
            )
        val BAD_CHARACTER =
            TextAttributesKey.createTextAttributesKey(
                "GDSHADER_BAD_CHARACTER",
