...
class GdsFormattingModelBuilder : FormattingModelBuilder {
    ...
    private fun createSpacingBuilder(settings: CodeStyleSettings): SpacingBuilder {
        ...
        return SpacingBuilder(settings, GdsLanguage)
            ...
            .beforeInside(GdsTypes.COLON, GdsTypes.HINT_SECTION).spaceIf(gds.SPACE_BEFORE_HINT_COLON)
            .afterInside(GdsTypes.COLON, GdsTypes.HINT_SECTION).spaceIf(gds.SPACE_AFTER_HINT_COLON)
