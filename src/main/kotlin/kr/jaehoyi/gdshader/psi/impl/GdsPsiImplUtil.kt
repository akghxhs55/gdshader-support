...
object GdsPsiImplUtil {
    @JvmStatic
    fun getName(element: GdsVariableNameDecl): String = element.text

    @JvmStatic
    fun setName(
        element: GdsVariableNameDecl,
        newName: String,
    ): PsiElement? {
    ...
    @JvmStatic
    fun getNameIdentifier(element: GdsVariableNameDecl): PsiElement? = element.node.findChildByType(GdsTypes.IDENTIFIER)?.psi
    ...
    @JvmStatic
    fun getReference(element: GdsVariableNameRef): PsiReference = GdsVariableReference(element, TextRange(0, element.textLength))

    @JvmStatic
    fun getName(element: GdsFunctionNameDecl): String = element.text

    @JvmStatic
    fun setName(
        element: GdsFunctionNameDecl,
        newName: String,
    ): PsiElement? {
        val identifier = GdsElementFactory.createIdentifier(element.project, newName) ?: return null
        element.firstChild.replace(identifier)
    ...
    @JvmStatic
    fun getNameIdentifier(element: GdsFunctionNameDecl): PsiElement? = element.node.findChildByType(GdsTypes.IDENTIFIER)?.psi
    ...
    fun getFunctionSpec(element: GdsFunctionNameDecl): FunctionSpec? {
        ...
        val parameters =
            parameterList.mapNotNull { param ->
    ...
    @JvmStatic
    fun getReference(element: GdsFunctionNameRef): PsiReference = GdsFunctionReference(element, TextRange(0, element.textLength))

    @JvmStatic
    fun getName(element: GdsStructNameDecl): String = element.text

    @JvmStatic
    fun setName(
        element: GdsStructNameDecl,
        newName: String,
    ): PsiElement? {
        val identifier = GdsElementFactory.createIdentifier(element.project, newName) ?: return null
        element.firstChild.replace(identifier)
    ...
    @JvmStatic
    fun getNameIdentifier(element: GdsStructNameDecl): PsiElement? = element.node.findChildByType(GdsTypes.IDENTIFIER)?.psi

    @JvmStatic
    fun getReference(element: GdsStructNameRef): PsiReference = GdsStructReference(element, TextRange(0, element.textLength))

    @JvmStatic
    fun getName(element: GdsStructMemberNameDecl): String = element.text

    @JvmStatic
    fun setName(
        element: GdsStructMemberNameDecl,
        newName: String,
    ): PsiElement? {
        val identifier = GdsElementFactory.createIdentifier(element.project, newName) ?: return null
        element.firstChild.replace(identifier)
    ...
    @JvmStatic
    fun getNameIdentifier(element: GdsStructMemberNameDecl): PsiElement? = element.node.findChildByType(GdsTypes.IDENTIFIER)?.psi

    @JvmStatic
    fun getReference(element: GdsStructMemberNameRef): PsiReference = GdsStructMemberReference(element, TextRange(0, element.textLength))
