...
class GdsBraceMatcher : PairedBraceMatcher {
    ...
    private val pairingAllowedTokenSet = TokenSet.create(
        TokenType.WHITE_SPACE, GdsTypes.LINE_COMMENT, GdsTypes.BLOCK_COMMENT, GdsTypes.PP_DEFINE_LINE, 
        ...
        GdsTypes.PP_PRAGMA_LINE, GdsTypes.COMMA, GdsTypes.COLON, GdsTypes.SEMICOLON,
        GdsTypes.PERIOD, GdsTypes.PARENTHESIS_CLOSE, GdsTypes.BRACKET_CLOSE,
